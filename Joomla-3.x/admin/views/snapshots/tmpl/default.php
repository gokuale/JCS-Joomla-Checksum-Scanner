    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            document.id('toolbar-new').addEvent('click', function () {
                jQuery("#loading_snapshotcreate").fadeIn("slow", "linear");
            });
        });
    </script>
    <form action="<?php echo JRoute::_('index.php?option=com_joomlachecksumscanner&view=snapshots'); ?>" method="post"
        ...
        <div id="j-main-container" class="span10">
            ...
            <div id="j-main-container">
                ...
                <div id="loading_snapshotcreate" style="display: none; text-align: center;">
                ...
                <table id="articleList" class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php echo JText::_('COM_JOOMLACHECKSUMSCANNER_TABLE_SNAPSHOTPREVIEW'); ?>
                        </th>
                        <th width="10%">
                            <?php echo JText::_('COM_JOOMLACHECKSUMSCANNER_TABLE_COUNT'); ?>
                        </th>
                        <th width="5%">
                            <?php echo JText::_('COM_JOOMLACHECKSUMSCANNER_TABLE_ALGORITHM'); ?>
                        </th>
                        </th>
                    </tr>
                    </thead>
                    ...
                    for($i = 0; $i < $n; $i++)
                    {
                        ...
                        <tr class="<?php echo 'row'.$k; ?>">
                            ...
                            <span class="hasTooltip"
                                  title="<?php echo htmlspecialchars(stripslashes($row->data_preview)); ?>">
                                <?php echo stripslashes($row->data_preview); ?>
                            </span>
                            </td>
                            <td class="small">
                            <span class="hasTooltip" title="<?php echo htmlspecialchars($row->count); ?>">
                                <?php echo $row->count; ?>
                            </span>
                            </td>
                            <td class="small">
                            <span class="hasTooltip" title="<?php echo htmlspecialchars($row->algorithm); ?>">
                ...
                <input type="hidden" name="controller" value="snapshots"/>
