...
class JoomlaChecksumScannerViewFilescount extends JViewLegacy
{
    protected $_state;

    function display($tpl = null)
    {
        JToolBarHelper::title(JText::_('COM_JOOMLACHECKSUMSCANNER')." - ".JText::_('COM_JOOMLACHECKSUMSCANNER_SUBMENU_COUNTFILES'), 'joomlachecksumscanner');

        if(JFactory::getUser()->authorise('joomlachecksumscanner.countfiles', 'com_joomlachecksumscanner'))
        {
            JToolBarHelper::custom('countfiles', 'new', 'new', JText::_('COM_JOOMLACHECKSUMSCANNER_COUNTFILES'), false);
        }
        ...
        JoomlaChecksumScannerHelper::addSubmenu('filescount');
